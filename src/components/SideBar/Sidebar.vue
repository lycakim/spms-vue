...
<div class="flex">
    ...
    >
      <div class="flex items-center justify-center mt-8">
        <div class="flex items-center">
          ...
          <span class="mx-2 text-2xl font-semibold text-gray-900">SPMS &nbsp;&nbsp;&nbsp;</span>
        </div>
      </div>
      ...
      <nav class="mt-10">
        ...
        <router-link
          ...
          :class="[$route.name === 'DashboardView' ? activeClass : inactiveClass]"
          to="/dashboard/d"
        >
          <svg
            class="w-5 h-5"
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200"
          :class="[$route.name === 'StudentList' ? activeClass : inactiveClass]"
          to="/dashboard/s"
        >
          <svg
            class="w-5 h-5"
        ...
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200"
          :class="[$route.name === 'ReportView' ? activeClass : inactiveClass]"
          to="/dashboard/r"
        >
          <svg
            class="w-5 h-5"
    ...
    <!-- <aside class="sm:w-full">
            <ul>
              <li> 
                <router-link to="/dashboard/d" v-slot="{ href, navigate, isActive }">
                  <a
                :href="href"
                @click="navigate"
                class="flex items-center px-4 py-1 mt-4 text-gray-600 rounded-md hover:bg-gray-200"
                :class="[
                  isActive
                    ? 'flex items-center px-4 py-1 text-green-700 bg-gray-200 rounded-md'
                    : 'flex items-center px-4 py-1 mt-4 text-gray-600 rounded-md hover:bg-gray-200',
                ]"
              >
              ...
              <li>
                <router-link to="/dashboard/s" v-slot="{ href, navigate, isActive }">
                  <a
                :href="href"
                @click="navigate"
                class="flex items-center px-4 py-1 mt-4 text-gray-600 rounded-md hover:bg-gray-200"
              ...
              >
                  ...
                  <span class="mx-4 font-medium">Student List</span>
                  </a>
                </router-link>
              </li>
              <li>
                <router-link to="/dashboard/r" v-slot="{ href, navigate, isActive }">
                  <a
                :href="href"
                @click="navigate"
                class="flex items-center px-4 py-1 mt-4 text-gray-600 rounded-md hover:bg-gray-200"
...
const activeClass = ref(
  "bg-gray-600 text-gray-100 border-gray-900 mx-3 rounded"
);
const inactiveClass = ref(
  "border-gray-900 text-gray-500 rounded mx-3 hover:bg-gray-300 hover:text-gray-500"
);
</script>